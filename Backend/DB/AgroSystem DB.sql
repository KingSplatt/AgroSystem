...
ALTER TABLE Sucursal ADD CONSTRAINT FK_Sucursal_CEDI FOREIGN KEY (IDCedi) REFERENCES CEDI (IDCedi), ADD CONSTRAINT FK_Sucursal_Ciudad FOREIGN KEY (IDCiudad) REFERENCES Ciudad (IDCiudad);

ALTER TABLE DetalleCompra ADD CONSTRAINT FK_DetalleCompra_Producto FOREIGN KEY (IDProducto) REFERENCES Producto (IDProducto), ADD CONSTRAINT FK_DetalleCompra_Compra FOREIGN KEY (IDCompra) REFERENCES Compra (IDCompra);

ALTER TABLE CEDI ADD CONSTRAINT FK_CEDI_Ciudad FOREIGN KEY (IDCiudad) REFERENCES Ciudad (IDCiudad);

ALTER TABLE Compra ADD CONSTRAINT FK_Compra_CEDI FOREIGN KEY (IDCedi) REFERENCES CEDI (IDCedi), ADD CONSTRAINT FK_Compra_Empleado FOREIGN KEY (IDEmpleado) REFERENCES Empleado (IDEmpleado);
...
ALTER TABLE DetalleVenta ADD CONSTRAINT FK_DetalleVenta_Producto FOREIGN KEY (IDProducto) REFERENCES Producto(IDProducto), ADD CONSTRAINT FK_DetalleVenta_Venta FOREIGN KEY (IDVenta) REFERENCES Venta(IDVenta);

ALTER TABLE DetalleVentaCredito ADD CONSTRAINT FK_DetalleVentaCredito_Venta FOREIGN KEY (IDVenta) REFERENCES Venta (IDVenta), ADD CONSTRAINT FK_DetalleVentaCredito_Producto FOREIGN KEY (IDProducto) REFERENCES Producto (IDProducto);
