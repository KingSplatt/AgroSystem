...
const NuevaVentaNormal = async (req, res) => {
    try {
        ...
        productos.forEach(async producto => {
            ...
            await pool.query(sqlDetalleVenta, parseInt(IDVenta[0][0].IDVenta), parseInt(producto.IDProducto), parseInt(producto.Cantidad), parseFloat(producto.PrecioUnitario));
        });
